...
-------------
BULK INSERT Usuario
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Usuario.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
...
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Encargado.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
...
BULK INSERT Sesion
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Sesion.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
...
BULK INSERT Funcion
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Funcion.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);		
...
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Vehiculo.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);		
...
BULK INSERT Arma
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Arma.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
...
BULK INSERT Disparo
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Disparo.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
...
FROM 'C:\Users\DELL\Downloads\Sedena\Sedena\Conductor.csv'
WITH (FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		ROWTERMINATOR='\n',
		MAXERRORS=5);
